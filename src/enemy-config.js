...
export const ENEMY_TYPES = freeze({
  zombie: {
    ...
    hp: 65, speed: [1.55, 2], large: false, heal: 0, stun: .56, knockScale: 1,
  ...
  forsaken: {
    ...
    hp: 100, speed: [1.8, 2.15], large: false, heal: 0, stun: .60, knockScale: .9,
  ...
  abomination: {
    ...
    hp: 205, speed: [1.1, 1.3], large: true, heal: 0, stun: .44, knockScale: .8,
  ...
  dreadlord: {
    ...
    hp: 430, speed: [1.4, 1.65], large: true, heal: 0, stun: .34, knockScale: .55,
    ...
    boss: {
      ...
      speed: [1.3, 1.3], heal: 0, stun: .22, knockScale: .25,
